    ...
    <ul className="navbar-nav">
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
          ...
          <span className="link-text"><Link to='/resume'>Resume</Link></span>
        </a>
      </li>
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
          ...
          <span className="link-text"><Link to='/aboutme'>About Me</Link></span>
        </a>
      </li>
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
          ...
          <span className="link-text"><Link to='/contactme'>Contact Me</Link></span>
        </a>
      </li>
      ...
      {/* <li className="nav-item" id="themeButton">
        <a href="#" className="nav-link">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 576 512"
            className="svg-inline--fa fa-sunglasses theme-icon fa-w-18 fa-7x"
          >
            <g className="fa-group">
              <path
                fill="aqua"
