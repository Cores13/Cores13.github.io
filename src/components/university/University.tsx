    ...
    return (
        <div className="university">
            ...
            <div className="universityBottom">
                <div><h4 className="schoolTitle">Engineer of Information Technology</h4>
                    <h6 className="schoolTitle">American University in Bosnia and Herzegovina, Tuzla, Bosnia and Herzegovina</h6>
