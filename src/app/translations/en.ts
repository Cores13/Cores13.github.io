export const strings = {
  ...
  "aboutMeInfo": `I'm a seasoned Full Stack Web Developer with over 2 years of hands-on experience. My expertise spans a wide array of technologies, including <strong>ReactJS, .NET, Laravel, Angular, NodeJS, Blade and TypeScript</strong>.<br /><br />
    ...
    Adapting to new technologies and workflows is second nature to me, and I'm continuously dedicated to honing my skills. <br /><br />I'm confident that my expertise would be a valuable asset to any team, enhancing the quality of projects.
    Feel free to explore my portfolio for a more detailed overview of my professional background. I'm enthusiastic about the opportunity to discuss how I can contribute to your endeavors.`,
